...
extern "C" {
    ...
    SHARD_API shard::TypeSymbol* Shard_GetArrayTypeUnderlyingType(shard::ArrayTypeSymbol* array);
    SHARD_API std::size_t Shard_GetArrayTypeLength(shard::ArrayTypeSymbol* array);
