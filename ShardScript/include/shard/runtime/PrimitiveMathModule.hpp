...
namespace shard
{
	...
	public:
		...
		ObjectInstance* EvaluateBinaryOperator(std::int64_t leftData, TokenType opToken, ObjectInstance* rightInstance);
		...
		ObjectInstance* EvaluateUnaryOperator(ObjectInstance* sourceInstance, std::int64_t data, TokenType opToken, bool rightDetermined);
