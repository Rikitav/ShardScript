...
namespace shard
{
	class SHARD_API IndexatorExpressionSyntax final : public ExpressionSyntax
	{
	...
	public:
		IndexatorExpressionSyntax(gmt::Ref<SyntaxNode> parent);
		virtual ~IndexatorExpressionSyntax() = default;
