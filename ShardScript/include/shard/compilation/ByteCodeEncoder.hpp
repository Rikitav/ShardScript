...
namespace shard
{
	...
	public:
		...
		void EmitLoadConstInt8(std::vector<std::byte>& code, std::int8_t value);
		void EmitLoadConstInt64(std::vector<std::byte>& code, std::int64_t value);
		void EmitLoadConstNativeInt(std::vector<std::byte>& code, std::intptr_t value);
		...
		void EmitLoadEnumField(std::vector<std::byte>& code, FieldSymbol* type);
		...
		void EmitCallDelegate(std::vector<std::byte>& code, DelegateTypeSymbol* type);
